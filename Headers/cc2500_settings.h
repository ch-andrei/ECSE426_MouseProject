...
// OLD: freq set to 2.433 GHz, note f_xosc = 26MHz
// NEW: freq set to 2483Mhz
#define VAL_CC2500_FREQ2 		0x5F
#define VAL_CC2500_FREQ1 		0x80	
#define VAL_CC2500_FREQ0 		0x00
